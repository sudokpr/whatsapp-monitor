...
export SEND_TELEGRAM TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID TELEGRAM_TOPIC_ID TELEGRAM_CONFIG RETENTION_DAYS DELETE_DIGEST_MD OLLAMA_URL OLLAMA_MODEL OLLAMA_TIMEOUT_SECONDS OLLAMA_CHUNK_CHARS OLLAMA_NUM_CTX OLLAMA_MERGE_CHUNKS ENABLE_OLLAMA LOG_FILE
